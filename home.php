...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="/css/restro.css">
    </head>
    <body>
        <header>
        ...
        <div id="id01" class="modal">
          ...
          <div id="id02" class="modal">
            ...
            <form class="modall-content" action="/action_page.php">
              <div class="rcontainer">
                ...
                <div class="clearfix">
                  ...
                  <button type="submit" name="register" onclick="document.getElementById('id02').style.display='none'" class="rcancelbtn" class="rsignupbtn">Sign Up</button>
                </div>
              </div>
            </form>
          </div>
